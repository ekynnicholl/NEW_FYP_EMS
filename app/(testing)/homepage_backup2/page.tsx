                            ...
                            <Confirmation_Modal
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="text-center mx-auto">
                                        ...
                                        <button className="text-slate-100 bg-slate-800 hover:bg-slate-900 font-medium text-sm rounded-lg px-[22px] lg:px-6 py-[10px] lg:py-[11px] text-center mr-5 focus:shadow-outline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900" onClick={handleDelete}>Delete</button>
                                    </div>
                                </div>
                            </Confirmation_Modal>
                    ...
                    <div className="w-full bg-slate-100 flex pb-28">
                        <div className="w-3/4 pr-1">
                            <div className="w-full flex">
                                ...
                                <div className="bg-white border border-slate-200 rounded-lg overflow-hidden p-6 h-[480px] ml-5 w-1/3 relative flex flex-col transition transform hover:scale-105" onClick={() => openModal('https://source.unsplash.com/600x300?party', latestEvent[0].intFID, latestEvent[0]?.intFDescription, latestEvent[0]?.intFStartDate, latestEvent[0]?.intFStartTime, latestEvent[0]?.intFEndTime, latestEvent[0]?.intFVenue, latestEvent[0]?.intFMaximumSeats)}>
                                ...
                                <div className="bg-white border border-slate-200 rounded-lg overflow-hidden p-6 h-[480px] ml-5 w-1/3 relative flex flex-col transition transform hover:scale-105" onClick={() => openModal('https://source.unsplash.com/600x300?birthday', latestEvent[1].intFID, latestEvent[1]?.intFDescription, latestEvent[1]?.intFStartDate, latestEvent[1]?.intFStartTime, latestEvent[1]?.intFEndTime, latestEvent[1]?.intFVenue, latestEvent[1]?.intFMaximumSeats)}>
                                    <div className="w-full h-[300px] mb-4 relative">
                                        <div className="absolute -inset-6">
                                            <img
                                ...
                                <div className="bg-white border border-slate-200 rounded-lg overflow-hidden p-6 h-[480px] ml-5 w-1/3 relative flex flex-col transition transform hover:scale-105" onClick={() => openModal('https://source.unsplash.com/600x300?new+year', latestEvent[2].intFID, latestEvent[2]?.intFDescription, latestEvent[2]?.intFStartDate, latestEvent[2]?.intFStartTime, latestEvent[2]?.intFEndTime, latestEvent[2]?.intFVenue, latestEvent[2]?.intFMaximumSeats)}>
                                    <div className="w-full h-[300px] mb-4 relative">
                                        <div className="absolute -inset-6">
                                            <img
                            ...
                            <div className="w-full flex mt-5">
                                ...
                                <div className="bg-white border border-slate-200 rounded-lg overflow-hidden p-6 h-[480px] ml-5 w-1/3 relative flex flex-col transition transform hover:scale-105" onClick={() => openModal('https://source.unsplash.com/600x300?events', latestEvent[3].intFID, latestEvent[3]?.intFDescription, latestEvent[3]?.intFStartDate, latestEvent[3]?.intFStartTime, latestEvent[3]?.intFEndTime, latestEvent[3]?.intFVenue, latestEvent[3]?.intFMaximumSeats)}>
                                    <div className="w-full h-[300px] mb-4 relative">
                                        <div className="absolute -inset-6">
                                            <img
                                ...
                                <div className="bg-white border border-slate-200 rounded-lg overflow-hidden p-6 h-[480px] ml-5 w-1/3 relative flex flex-col transition transform hover:scale-105" onClick={() => openModal('https://source.unsplash.com/600x300?balloon', latestEvent[4].intFID, latestEvent[4]?.intFDescription, latestEvent[4]?.intFStartDate, latestEvent[4]?.intFStartTime, latestEvent[4]?.intFEndTime, latestEvent[4]?.intFVenue, latestEvent[4]?.intFMaximumSeats)}>
                                    <div className="w-full h-[300px] mb-4 relative">
                                        <div className="absolute -inset-6">
                                            <img
                                ...
                                <div className="bg-white border border-slate-200 rounded-lg overflow-hidden p-6 h-[480px] ml-5 w-1/3 relative flex flex-col transition transform hover:scale-105" onClick={() => openModal('https://source.unsplash.com/600x300?celebration', latestEvent[5].intFID, latestEvent?.intFDescription, latestEvent[5]?.intFStartDate, latestEvent[5]?.intFStartTime, latestEvent[5]?.intFEndTime, latestEvent[5]?.intFVenue, latestEvent[5]?.intFMaximumSeats)}>
                                    <div className="w-full h-[300px] mb-4 relative">
                                        <div className="absolute -inset-6">
                                            <img
