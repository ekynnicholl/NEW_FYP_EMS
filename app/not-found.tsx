...
const PageNotFound = () => {
	return (
		<div className="min-h-screen flex flex-col justify-center items-center text-center py-20 bg-slate-100 dark:bg-dark_mode_card p-5 -mt-12 lg:-mt-5">
			<Image src={image_404.src} alt="error 404" width={300} height={420} className="w-[300px] lg:w-[420px]" />
			<div className="max-w-[546px] mx-auto w-full mt-6">
				<div>
					...
					<div className="text-sm lg:text-base font-normal mb-6 lg:mb-8 text-slate-700">The page you are looking for does not exist.</div>
