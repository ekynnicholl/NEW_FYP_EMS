...
export default function Home() {
	...
	return (
		<div className="min-h-[670px] text-gray-900 flex justify-center">
		<div className="max-w-screen m-0 lg:m-6 bg-white shadow sm:rounded-lg flex justify-center flex-1 lg:flex-row">
			...
			<div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 flex flex-col justify-start items-start">
				<div className="mt-12">
					<div className="w-full -mt-16">
						<div
							className="bg-slate-100 px-6 py-4 rounded-md mt-3"
							style={{
								maxHeight: "530px",
								minHeight: "300px",
								overflowY: "auto",
							...
							<div className="flex flex-col">
								<div className="mb-4">
									<div className="flex items-center">
										...
										/>
										<p className="text-sm ml-2 font-bold text-slate-800">
											Friendly Bot
										</p>
									</div>
									<p className="text-xs bg-white p-2 rounded-md mt-2">
											...
											.map(
												(
													...
													if (
														...
														return (
															<p
																className="text-xs bg-white p-2 rounded-md mt-2"
																key={
																	message.id +
																	index
																}>
					...
					<form
						...
						<input
							type="text"
							className="flex-1 bg-slate-100 p-2 pl-4 rounded-full text-xs lg:text-sm outline-slate-500"
