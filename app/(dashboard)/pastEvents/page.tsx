								...
								<tbody>
									{searchQuery.length > 0 && dataResults.length === 0 ? (
										...
										sortedData.slice((currentPage - 1) * entriesToShow, currentPage * entriesToShow).map((event, index) => (
											<tr
												className="flex border-b border-gray-200 bg-white text-xs lg:text-sm dark:bg-dark_mode_card dark:border-[#363B3D]"
												key={index}
											>
												...
												<td className="flex-1 py-5">
													<p className="text-gray-900 -ml-10 dark:text-dark_text w-52">{event.intFEventName}</p>
												</td>

												<td className="flex-1 py-5 -ml-3">
													<p className="text-gray-900 -ml-1 dark:text-dark_text">{event.intFEventDescription}</p>
												</td>
						...
						<div className="p-5 bg-slate-100 h-[520px] lg:w-[1160px] lg:h-[420px] ml-1 overflow-auto">
									...
									{subEvents
										...
										.map((subEvent, index) => (
											<tr className="flex border-b border-gray-200 bg-white" key={index}>
												<td className="flex-1 py-5 text-xs mt-1 lg:text-xs ml-5">
													<div>
														<div className="ml-[2px]">
															<p className="text-gray-900">{(currentPage - 1) * entriesToShow + index + 1}</p>
														</div>
													</div>
												</td>
												<td className="flex-1 px-3 py-5 text-xs lg:text-md ">
													<p className="text-gray-900 -ml-8">{subEvent.sub_eventsName}</p>
												</td>

												<td className="flex-1 px-3 py-5 text-xs lg:text-md ">
													<p className="text-gray-900 ml-1">{subEvent.sub_eventsOrganizer}</p>
												</td>

												<td className="flex-1 px-3 py-5 text-xs lg:text-md">
													<p className="text-gray-900 ml-6">{subEvent.sub_eventsVenue}</p>
												</td>
												...
												<td className="flex-1 px-3 py-5 text-xs lg:text-md">
													<p className="text-gray-900 ml-5">{subEvent.sub_eventsMaxSeats}</p>
												</td>
											</tr>
										))}
								</tbody>
							...
							<div className="grid grid-cols-1 gap-4 lg:hidden">
								{subEvents
									.filter(subEvent => subEvent.sub_eventsMainID === selectedEvent.intFID)
									.map((subEvent, index) => (
										<div key={subEvent.sub_eventsID} className="bg-slate-100 p-4 rounded-lg shadow overflow-auto">
											<table className="w-full">
												...
												<tr className="border-b-2 border-gray-200 bg-gray-100">
													...
													<td className="float-right flex text-xs mt-3 px-4">{subEvent.sub_eventsName}</td>
												</tr>
												<tr className="border-b-2 border-gray-200 bg-gray-100">
													<th className="py-3 float-left text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
														Organizer
													</th>
													<td className="float-right flex text-xs mt-3 px-4">{subEvent.sub_eventsOrganizer}</td>
												</tr>
												<tr className="border-b-2 border-gray-200 bg-gray-100">
													<th className="py-3 float-left text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
														Venue
													</th>
													<td className="float-right flex text-xs mt-3 px-4">{subEvent.sub_eventsVenue}</td>
												</tr>
												<tr className="border-b-2 border-gray-200 bg-gray-100">
													<th className="py-3 float-left text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
														Start Date
												...
												<tr className="border-b-2 border-gray-200 bg-gray-100">
													...
													<td className="float-right flex text-xs mt-3 px-4">{subEvent.sub_eventsMaxSeats}</td>
												</tr>
											</table>
										</div>
									))}
							...
							<div key={event.intFID} className="bg-slate-100 p-4 rounded-lg shadow">
								<table className="w-full">
									<tr className="border-b-2 border-gray-200 bg-gray-100">
										...
										<td className="float-right flex text-xs mt-3 px-4">{(currentPage - 1) * entriesToShow + index + 1}</td>
									</tr>
									<tr className="border-b-2 border-gray-200 bg-gray-100">
										...
										<td className="float-right text-xs mt-3 px-4">{event.intFEventName}</td>
									</tr>
									<tr className="border-b-2 border-gray-200 bg-gray-100">
										<th className="py-3 float-left text-left text-xs lg:text-sm font-semibold text-gray-600 uppercase tracking-wider whitespace-nowrap">
											Description
										</th>
										<td className="float-right text-xs mt-3 px-4">{event.intFEventDescription}</td>
									</tr>
									<tr className="border-b-2 border-gray-200 bg-gray-100">
										<th className="py-3 float-left text-left text-xs font-semibold text-gray-600 uppercase tracking-wider whitespace-nowrap">
											Start Date
										</th>
										<td className="float-right text-xs mt-3 px-4">{event.intFEventStartDate}</td>
									</tr>
									<tr className="border-b-2 border-gray-200 bg-gray-100">
										<th className="py-3 float-left text-left text-xs font-semibold text-gray-600 uppercase tracking-wider whitespace-nowrap">
											Status
