...
const UpcomingEventsLanding = () => {
    ...
    const cardStyles = (index: number) => `card bg-white rounded-lg shadow-lg border-1 border-black-500 sm:w-1/3 sm:m-4 ${cardWidths[index]} ${cardHeights[index]} transition-all ease-in-out space-y-4 w-full sm:w-auto`;
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <animated.div style={fadeIn_Card} className="cards-container overflow-hidden mt-4 relative w-full sm:w-3/4 px-4 sm:px-0">
            <div className="slider flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0">
                    {upcomingEvents.slice(startIndex, startIndex + (window.innerWidth < 640 ? 1 : 3)).map((event, index) => {
                        ...
                        return (
                            <div key={index} className={`${cardStyles(index)}`}>
                                ...
                                <div className="content-container pl-6 pr-6 break-words">
