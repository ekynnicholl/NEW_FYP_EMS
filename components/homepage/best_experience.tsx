    ...
    return (
        <Element name="section2">
            <div className="flex flex-col items-center justify-center mb-10">
                ...
                <div className="cards-container flex items-center justify-center overflow-hidden mt-4 relative">
                    <div className="slider flex items-center justify-center">
                        <animated.div style={fadeIn_Card1} className={`h-[330px] card bg-white rounded-lg shadow-lg border-1 border-black-500 m-4 w-full space-y-4 pl-4 pt-4 pr-4`}>
                        ...
                        <animated.div style={fadeIn_Card2} className={`h-[330px] card bg-white rounded-lg shadow-lg border-1 border-black-500 w-full m-4 space-y-4 pl-4 pt-4 pr-4`}>
                            <div className="flex items-center justify-center">
                                <Image
                            ...
                            <p className="text-gray-600 text-center">Track your past attended events!</p>
                            <div className="flex mt-4">
                                <p className="text-sm font-bold mt-1"></p>
                            </div>
                        </animated.div>
                        <animated.div style={fadeIn_Card3} className={`h-[330px] card bg-white rounded-lg shadow-lg border-1 border-black-500 m-4 w-full m-4 space-y-4 pl-4 pt-4 pr-4`}>
                            <div className="flex items-center justify-center">
                                <Image
                            ...
                            <p className="text-gray-600 text-center">Submit your forms online for convenience!</p>
