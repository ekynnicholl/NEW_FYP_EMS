...
const AttendanceSettings = () => {
	...
	return (
		<div
			className={`pl-5 pr-5 pt-4 pb-4 mb-4 bg-white rounded-lg shadow-lg dark:bg-dark_mode_card text-left transition-max-w duration-300 ease-in-out overflow-y-auto max-h-[500px] ${
				isExpanded ? "max-w-full" : "max-w-[400px]"
			}`}
		>
