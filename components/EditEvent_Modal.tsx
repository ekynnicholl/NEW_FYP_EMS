  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center z-[999]" id="wrapper">
      <div className="w-[400px] lg:w-[525px] flex flex-col relative p-10 lg:p-0">
        <div>
          <button className="text-slate-500 text-md md:text-lg lg:text-2xl absolute top-1 right-3 hover:font-medium mt-10 lg:mt-0 mr-[45px] lg:mr-3 dark:text-slate-200" onClick={() => onClose()}>x</button>
