  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center z-[100]" id="wrapper" onClick={handleClose}>
      <div className="w-[395px] lg:w-[530px] flex flex-col relative p-10 lg:p-0">
        <div>
          <button className="text-slate-100 font-medium text-xl md:text-xl lg:text-2xl absolute top-1 right-3 transform hover:scale-105 mt-[38px] lg:mt-0 mr-[40px] lg:mr-[10px] z-[150] dark:text-slate-200" onClick={() => onClose()}>x</button>
