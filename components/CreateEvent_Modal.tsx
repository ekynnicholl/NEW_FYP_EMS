...
const Modal: React.FC<ModalProps> = ({ isVisible, onClose, children }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center z-[999]" id="wrapper">
      <div className="w-[372px] lg:w-[531px] flex flex-col relative p-10 lg:p-0">
        <div>
          ...
          <div className="bg-white p-2 rounded-lg border border-slate-200 shadow-md h-[550px] lg:h-[670px] lg:max-h-[90vh] overflow-y-auto">
            {children}
          </div>
        </div>
      </div>
