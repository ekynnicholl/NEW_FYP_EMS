					...
					<div className="p-4 mb-4 bg-white rounded-lg shadow-lg dark:bg-dark_mode_card max-h-screen overflow-auto">
						...
						{notifications.length > 0 ? (
							notifications.map(notification => (
								...
								>
									<Link href={notification.notifLink} target="_blank" className="flex flex-1">
										<div className="w-full p-3 cursor-pointer ">
											<div>
												<p>
													<span className="font-bold">[{notification.notifType}]</span> {notification.notifDesc}
												</p>
											</div>
									...
									{hoveredNotification === notification.notifID && (
										<DropdownMenu>
											<DropdownMenuTrigger>
												<BsThreeDotsVertical size={30} className="-mt-[2px] bg-gray-200 rounded-full p-1.5 text-black-500" />
											</DropdownMenuTrigger>
