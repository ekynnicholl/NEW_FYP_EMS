				...
				<DropdownMenuContent side="top" sideOffset={-4}>
					...
					<div className="h-[383px] overflow-auto w-[450px]">
						{notifications.length > 0 ? (
							notifications.map(notification => (
								...
								>
									<div
										className="items-center pl-2.5 cursor-pointer flex-1 flex hover:bg-gray-100 rounded-md dark:hover:bg-black-500 dark:text-dark_text"
										...
										>
											<div className="flex items-center pl-2.5 cursor-pointer flex-1">
												...
												<div className="flex flex-col justify-between pl-3 flex-grow">
													<div className="text-[12px] pt-2.5 text-justify pr-3">{notification.notifDesc}</div>
							...
							<div>
								<div className="text-gray-400 text-[12px] text-center">You&apos;re all caught up! You have no new notifications.</div>
							</div>
						)}
					</div>
					<DropdownMenuSeparator />
					<DropdownMenuItem>
						<a href="/notifications">
							<div className="text-center text-blue-500 cursor-pointer">View All Notification(s)</div>
						</a>
					</DropdownMenuItem>
				</DropdownMenuContent>
			</DropdownMenu>
