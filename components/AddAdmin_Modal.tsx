...
const Modal: React.FC<ModalProps> = ({ isVisible, onClose, children }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center z-[999]" id="wrapper">
      <div className="lg:w-[1250px] flex flex-col relative p-10 lg:p-0 dark:bg-dark_mode_card">
        <div>
          ...
          <div className="bg-white p-2 rounded lg:rounded-lg border border-slate-200 shadow-md h-[550px] lg:h-[540px] overflow-y-hidden overflow-x-hidden dark:bg-dark_mode_card dark:border-[#253345]">
            {children}
          </div>
        </div>
      </div>
