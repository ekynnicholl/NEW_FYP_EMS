...
export default function DashboardExternalForm({ data, faculties }: { data: ExternalForm; faculties: string[] }) {
						...
						<div className="flex gap-3">
							...
							<DropdownMenu>
								...
								<DropdownMenuContent className="p-3 w-64 font-semibold text-[15px] rounded-2xl text-gray-500">
									<DropdownMenuItem className="p-3 cursor-pointer rounded-xl flex gap-2">
										<Undo2 size={20} />
										Revert to Staff
									</DropdownMenuItem>
									<DropdownMenuItem className="p-3 cursor-pointer rounded-xl flex gap-2">
										...
										<FormItem>
											...
											<div className="w-full h-[300px] border-2 border-gray-300 rounded-md grid place-items-center">
												{externalForm.verification_signature ? (
													<Image src={externalForm.verification_signature ?? ""} width={300} height={300} alt="Signature" />
												) : (
													<div className="text-gray-500">No signature uploaded</div>
												)}
											</div>
											...
											<FormItem>
												...
												<div className="w-full h-[300px] border-2 border-gray-300 rounded-md grid place-items-center">
													{externalForm.approval_signature ? (
														<Image src={externalForm.approval_signature ?? ""} width={300} height={300} alt="Signature" />
													) : (
														<div className="text-gray-500">No signature uploaded</div>
													)}
												</div>
