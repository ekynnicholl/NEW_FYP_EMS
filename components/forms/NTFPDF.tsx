                ...
                <div>
                    {formDetails.map((details) =>
                        <form key={details.formID}>
                            ...
                            <fieldset className=" text-[13px] bg-slate-950 h-[155px]"><span className="text-slate-50 font-semibold uppercase ml-2">Section 3: Logistic Arrangement<sup>2</sup></span>
                            ...
                            {/* Section 4: Funding */}
                            <fieldset className="p-[0.5px] text-[13px] bg-slate-950"><span className="text-slate-50 font-semibold uppercase ml-2">Section 4: Funding</span></fieldset>
                            ...
                            <div className="grid grid-cols-2">
                                ...
                                <div className="col-span-1 normal-case text-[11.5px] bg-gray-200 leading-3 border-r border-l border-slate-950">
                                    ...
                                    <div className="ml-6 mt-1">
                                        ...
                                        <label>Position Title<span className="ml-[15px]">:</span></label>
                                        ...
                                        <label>Date<span className="ml-[56px]">:</span></label>
                                        <input type="text" className="bg-gray-200 ml-2 w-60" value={formatDate(details.applicant_declaration_date)} /><br />
                                    </div>
                                </div>
                                ...
                                <div className="col-span-1 normal-case text-[11.5px] bg-gray-200 leading-3 border-r border-slate-950">
                                    ...
                                    <div className="mx-4 mt-6">
                                        ...
                                        <label>Date<span className="ml-[56px]">:</span></label>
                                        <input type="text" className="bg-gray-200 ml-2 w-60" value={formatDate(details.verification_date)} /><br />
                                    </div>
                                </div>
                            </div>
                            {/* section 7: approval */}
                            <fieldset className=" p-[0.5px] text-[13px] bg-slate-950"><span className="text-slate-50 font-semibold uppercase ml-2">Section 7: Approval</span> <span className="italic normal-case text-slate-50">&#40;HMU / Dean / Director / DVC & CEO&#41;</span></fieldset>
                            ...
                            <div className="mt-3 text-[11px]">
                                ...
                                <p className="float-right font-arial-narrow">Page <span className="font-bold">1</span> of <span className="font-bold">1</span></p>
                            </div>
